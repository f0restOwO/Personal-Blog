...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a class="navbar-brand text-success" href="/Blog/admin/main">博客管理</a>
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            <li class="nav-item">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="javascript:void(0);" onclick="fullScreen('添加文章','/Blog/admin/article/add')">文章</a>
                        <!-- <a class="dropdown-item" href="#">评论</a>-->
                    </div>
                </div>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="/Blog/admin/main">主页 </a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="/Blog/admin/article/list">文章管理</a>
    
            </li>

        </ul>
        <form class="form-inline my-2 my-lg-0" action="/Blog/admin/article/search" method="GET">
        ...
        <a class="btn btn-outline-danger btn-sm" href="/Blog/admin/logout" role="button">退出</a>
    </div>
</nav>
<br>
<table class="table table-sm">
    ...
    <c:forEach items="${articles}" var="article">
        <tr>
            ...
            <td>${article.time}</td>
            <td>${article.click}</td>
            <td><button type="button" class="btn btn-outline-info btn-sm" onclick="fullScreen('《${article.title}》','/Blog/admin/article/detail?id=${article.id}')">详情</button></td>
            <td><button type="button" class="btn btn-outline-success btn-sm" onclick="fullScreen('《${article.title}》|评论管理','/Blog/admin/article/comment?id=${article.id}')">评论</button></td>
            <td><button type="button" class="btn btn-outline-primary btn-sm" onclick="fullScreen('《${article.title}》|编辑','/Blog/admin/article/edit?id=${article.id}')">编辑</button>&nbsp;&nbsp;</td>
...
<nav aria-label="Page navigation example" style="position: absolute;bottom: 10px;left: 42%">
    <ul class="pagination justify-content-center">
        <li class="page-item  <c:if test="${pageInfo.pageNum==1}">disabled</c:if> ">
            <a class="page-link" href="/Blog/admin/article/list?page=1" >&laquo;</a>
        </li>
        ...
        <li class="page-item  <c:if test="${pageInfo.pageNum==pageInfo.pages}">disabled</c:if> ">
            <a class="page-link" href="/Blog/admin/article/list?page=${pageInfo.pages}">&raquo;</a>
        </li>
    </ul>
</nav>
