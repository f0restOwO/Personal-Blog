...
<head>
    <meta charset="UTF-8">
    <title>星·光</title>
    <link rel="shortcut icon" type="image/x-icon" href="/Blog/static/img/web-icon.png" media="screen" />
    <link rel="stylesheet" href="/Blog/static/css/bootstrap.min.css">
...
<%--    <script src="/Blog/static/js/jquery.slim.min.js"></script>--%>
    <style>
        ...
        *{
        ...
        #bg {
            position: relative;
            background: url("${pageContext.request.contextPath}/static/img/296494-106.jpg") no-repeat gray;
        ...
        #header nav figure
        {
            background:url("${pageContext.request.contextPath}/static/img/bg.png");
            height: 50px;
            width: 50px;
            background-size:cover ;
...
<body background="/Blog/static/img/bg.png" >
...
<div>
        ...
        <nav>
            ...
            <div class="my-info" onmouseover="hiddeewm()" onmouseout="hiddeewm()">
                ...
                <div id="hiddenewm" hidden="true" >
                    <img src="/Blog/static/img/me.jpg" width="200px" height="200px" >
                    <p></p>
                </div>
            </div>
        </nav>
    ...
    <div class="form-horizontal" role="form" style="margin:10px">
        <div class="form-group">
            <%--@declare id="inputpassword"--%><label for="inputPassword" class="col-sm-2 control-label">评论</label>
            <div class="col-sm-3">
    ...
    <div style="position: relative;left: 12%">
        <c:if test="${!empty lastArticle }">
            <div ><a href="${pageContext.request.contextPath}/article/?id=${lastArticle.id}"><h4><span class="label label-primary">上一篇:${lastArticle.title}</span></h4></a></div>
        </c:if>
        <c:if test="${!empty nextArticle }">
            <div><a href="${pageContext.request.contextPath}/article/?id=${nextArticle.id}"><h4><span class="label label-success">下一篇:${nextArticle.title}</span></h4></a></div>
        </c:if>
    </div>
</div>
